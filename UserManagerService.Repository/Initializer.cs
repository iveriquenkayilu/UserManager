...
namespace UserManagerService.Repository
{
    public class Initializer : IAsyncInitializer
    {
        ...
        private async Task AddDefaultValuesAsync()
        {
            ...
            {
                await _roleManager.CreateAsync(new Role { Name = RoleConstants.ADMIN, CreatedAt = DateTime.Now });
            ...
            if (!await _dbContext.Users.AnyAsync())
            {
                ...
                await CreateUser(roles, "FirstName", "Last Name", "test@rc.com", "user", Admin.DefaultPassword);
